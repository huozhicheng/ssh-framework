...
<html lang="en">
  <head>
    ...
    <link href="<%=contextPath%>/public/css/bootstrap.css" rel="stylesheet">
    <link href="<%=contextPath%>/public/js/bootstrap-responsive.css" rel="stylesheet">
...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
	    ...
	    <span>
		    <form class="well" action="<%=contextPath%>/search" method="post">
